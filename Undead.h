...
public:
	...
	Undead(float p_x, float p_y, SDL_Texture* p_text);
	~Undead();
	void Update(Player& p_player, Secret& p_secret, std::vector<Game_Map>& levelList, bool p_a, Mix_Chunk* p_undeadSFX[]);
	...
	void GetHit(Player& p_player, Secret& p_secret, bool p_a, Mix_Chunk* p_undeadSFX[]);
...
private:
	...
	const int UNDEAD_WIDTH = 16;
	const int UNDEAD_HEIGHT = 32;
	const int UNDEAD_VAL = 2;
	const int FRAME_WIDTH = 80;
	const int FRAME_HEIGHT = 48;
	const int MAX_DISTANCE = 100;

	static const int IDLING_ANIMATION_FRAME = 8;
	static const int WALKING_ANIMATION_FRAME = 8;
	static const int ATTACKING_ANIMATION_FRAME = 5;
	static const int BEINGHIT_ANIMATION_FRAME = 4;
	static const int DEATH_ANIMATION_FRAME = 6;
