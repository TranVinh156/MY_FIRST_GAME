...
void Player::Update(std::vector<Skeleton*>& skeletonList, std::vector<Game_Map>& levelList, Boss& p_boss)
{
	Gravity();
	//on_ground_ = true;
...
void Player::GetHit(std::vector<Skeleton*>& skeletonList, Boss& p_boss)
{
